              ...
              <table className="table" style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ borderBottom: '1px solid var(--border-color)', textAlign: 'left', fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                    ...
                    <th style={{ padding: '8px 12px' }}>{t('share_of_traffic')}</th>
                  </tr>
                </thead>
                <tbody>
                  {users.map(u => (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div style={{ overflowX: 'auto' }}>
                <table className="table" style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead>
                    <tr style={{ borderBottom: '1px solid var(--border-color)', textAlign: 'left', fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                      <th style={{ padding: '8px 12px' }}>{t('table_device')}</th>
                      <th style={{ padding: '8px 12px' }}>{t('table_ip_mac')}</th>
                      <th style={{ padding: '8px 12px' }}>{t('table_user')}</th>
                      <th style={{ padding: '8px 12px' }}>{t('download_rx')}</th>
                      <th style={{ padding: '8px 12px' }}>{t('upload_tx')}</th>
                      <th style={{ padding: '8px 12px' }}>{t('table_total')}</th>
                      <th style={{ padding: '8px 12px' }}>{t('table_share')}</th>
                      <th style={{ padding: '8px 12px' }}>{t('table_speed_limit')}</th>
                    </tr>
                  </thead>
                  <tbody>
